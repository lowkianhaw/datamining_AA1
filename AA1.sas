...
* Project Path: ~;
* Project Name: Final_AA1;
* Diagram Id: EMWS1;
* Diagram Name: Customer Purchase;
* Generated by: s2190839;
* Date: 07JAN2024:11:58:57;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* Macro Variables;
*------------------------------------------------------------*;
...
%let EM_PROJECTNAME =;
%let EM_WSNAME =;
%let EM_WSDESCRIPTION =Customer Purchase;
...
id= "FIMPORT";
property="IFileName";
value= "/home/u63463961/Final_AA1/Workspaces/EMWS1/Customer_Combined Preparation.csv";
output;
id= "FIMPORT";
